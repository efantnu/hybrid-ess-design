...
filename = 'energy_storage_results_step12';
...
writetable(PlotTable,'results-step12','Delimiter','\t');


%% Energy calculations
rtr = 0.03;     % Maximum transient frequency deviation [pu]
rss = 0.02;     % Maximum steady-state frequency deviation [pu]
Tarr = 5;      % Arrest period [s]
Treb = 180;      % Rebound period [s]
